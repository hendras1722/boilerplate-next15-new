      ...
      <div className="bg-white rounded-lg shadow-lg max-w-sm w-full mx-4 p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-start gap-3">
            <div className={`text-2xl mt-0.5 ${iconColor[type]}`}>
              {iconMap[type]}
            </div>
        ...
        <div className={`p-3 rounded border ${colorClasses[type]} mb-6`}>
          {data.content}
        </div>
        ...
        <button onClick={data.action} className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded transition-colors">
          Action
        </button>
      </div>
    </div>
