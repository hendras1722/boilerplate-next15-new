    ...
    <div className="p-6 space-y-6">
      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-2xl mx-auto space-y-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">MultiSelect Component Demo</h1>
            <p className="text-gray-600">Select from real API data with pagination support</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            {singleValue && !Array.isArray(singleValue) && (
              <p className="text-sm text-gray-600">
                Selected: <span className="font-medium">{singleValue.label}</span>
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700">Static Items (No API)</label>
            <MultiSelect
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-2">
                <label className="block text-xs font-medium text-gray-700">Outline</label>
                <MultiSelect variant="outline" placeholder="Outline..." items={[]} />
              </div>
              <div className="space-y-2">
                <label className="block text-xs font-medium text-gray-700">Solid</label>
                <MultiSelect variant="solid" placeholder="Solid..." items={[]} />
              </div>
              <div className="space-y-2">
                <label className="block text-xs font-medium text-gray-700">Soft</label>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 mb-2">
              Try opening this at the bottom of the viewport - dropdown will appear above!
            </p>
            <MultiSelect
          ...
          <div className="space-y-2">
            ...
            {postValue && !Array.isArray(postValue) && (
              <p className="text-sm text-gray-600 mt-1">
                Selected: <span className="font-medium">{JSON.stringify(postValue)}</span>
              </p>
            )}
          </div>
        </div>
      </div>
      <Marquee pauseOnHover speed={120} reverse className="bg-gray-50 py-4">
        <span className="mx-8 text-xl font-semibold">🔥 Fast. Secure. Reliable.</span>
        <span className="mx-8 text-xl font-semibold">⚡ Powered by Tailwind</span>
        <span className="mx-8 text-xl font-semibold">💎 Customizable Design</span>
      </Marquee>
    </div>
  );
}
